    ...
    <AboutContent id="about">
      <AboutText>
        ...
        <AboutParagraph>
          ...
          . I've worked on multiple projects to improve my coding skills, and I
          did an internship with L'Enfant as a full stack developer. I am
          accustomed to JavaScript technologies such as{" "}
          <Highlight>Express.JS, Node.JS, React.js</Highlight>. I've worked with
          a wide array of <Highlight>cloud databases</Highlight>, such as{" "}
          ...
          <Highlight>Ruby on Rails</Highlight> and <Highlight>Flask</Highlight>.
          <br /> <br />
